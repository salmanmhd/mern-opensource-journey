...
// Example: Busy waiting for a condition to be true
function busyWait(conditionFunction) {
...
// Suppose we want to wait until the counter becomes greater than or equal to 5
busyWait(() => counter >= 5);

console.log("Counter is now 5 or greater.");
